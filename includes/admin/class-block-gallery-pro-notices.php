 ...
 * @since 1.0.0
 */
class Block_Gallery_Pro_Notices {
	...
	public function __construct() {
		...
		// Check if Block Gallery is installed.
		foreach ( $plugins as $plugin_path => $plugin ) {
			if ( 'Block Gallery' === $plugin['Name'] ) {
		...
		// Actions.
		add_action( 'plugins_loaded', array( $this, 'fire_notices' ) );
	}
...
return new Block_Gallery_Pro_Notices();
