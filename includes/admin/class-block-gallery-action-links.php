...
class Block_Gallery_Action_Links {
	...
	public function plugin_action_links( $links ) {
		...
		$links['go_pro'] = sprintf( '<a href="%1$s" target="_blank" class="block-gallery-plugins-gopro" style="color: #39b54a;font-weight: 700;">%2$s</a>', esc_url( $url ), esc_html__( 'Go Pro', '@@textdomain' ) );
